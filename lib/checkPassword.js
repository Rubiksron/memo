...
function checkPassword(request, response) {
  ...
  var samplePassword = 'salmon cookies';
  var hashed;
  
  // bcrypt.hash(samplePassword, 10, function(err, hash) {
  //   console.log('hash 1: ', hash);
  //   console.log('samplePassword 1: ', samplePassword);
  //   var hashed = hash;
  //   return hashed;
  // });

  // bcrypt.compare(samplePassword, hashed, function(err, result) {
  //   console.log('hash 2: ', hashed);
  //   console.log('samplePassword 2: ', samplePassword);
